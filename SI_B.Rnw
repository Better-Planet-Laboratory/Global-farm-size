...
<<finalmap, fig.cap='Final map, where dominant farm size (ha) is shown per pixel for the mode of the 100 generated maps.', out.width='100%', size='footnotesize', echo=F>>=

knitr::include_graphics('finalMap.png')

# Uncomment to produce map
# Comment out for knitr compilation
# this can cause some computers to push memory caps
# gc()
