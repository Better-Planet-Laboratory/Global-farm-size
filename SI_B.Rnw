...
<<finalmap, fig.cap='Final map showing the dominant farm size (ha) per pixel for the mode of the 100 generated maps', out.width='0.6\\linewidth', fig.height=5, fig.width=7, size='footnotesize', echo=F>>=
